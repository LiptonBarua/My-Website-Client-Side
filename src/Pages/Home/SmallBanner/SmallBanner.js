        ...
        <div>
            {
                ...
                <div className="px-16 h-44 text-black md:flex items-center md:justify-between">
                    <h1 className="text-2xl font-bold">Are you ready to hire me for <br></br> your next Project ?</h1>
                    <a href='#contact'><button className="text-black border mt-5 md:mt-0   border-black hover:bg-[black] hover:text-[white] active:bg-black font-bold uppercase text-sm px-6 py-3 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button">Contact Me</button></a>
                </div>
            </div>
            :
